...
\item 2つのリストから計算される\cs{QIcov}, \cs{QIpcc}\emph{以外}の統計量は，
内部リストの変更に伴い再計算される．
\end{itemize}
...
\loop
  ...
  \ifnum\value{iter}<155
\repeat
\QIrecalc{iter}

%\paragraph{元データ}\leavevmode\par
%\begin{quote}
%  \qiout{rand}
%\end{quote}
